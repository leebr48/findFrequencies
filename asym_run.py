...
if __name__ == '__main__':
    ...
    np.savetxt('asym_eigenvalues.txt', eigenvalues.view(float).reshape(-1, 2), fmt='%.16e', header='Real Imaginary')
    np.savetxt('asym_eigenvectors_real.txt', eigenvectors.real, fmt='%.16e', header='Eigenvectors (real part)')
    np.savetxt('asym_eigenvectors_imag.txt', eigenvectors.imag, fmt='%.16e', header='Eigenvectors (imaginary part)')
