...
if __name__ == '__main__':
    ...
    np.savetxt('sym_eigenvalues.txt', eigenvalues.view(float).reshape(-1, 2), fmt='%.16e', header='Real Imaginary')
    np.savetxt('sym_eigenvectors_real.txt', eigenvectors.real, fmt='%.16e', header='Eigenvectors (real part)')
    np.savetxt('sym_eigenvectors_imag.txt', eigenvectors.imag, fmt='%.16e', header='Eigenvectors (imaginary part)')
